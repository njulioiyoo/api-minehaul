...
Route::middleware(['validate.api', 'json.api', 'verify.user.role'])->group(function () {
    ...
    Route::prefix('devices')->group(function () {
        ...
        Route::post('/', [DeviceController::class, 'showDevice'])->name('device.show')->middleware('verify.user.permission:show-device');
    });
    ...
    Route::prefix('vehicles')->group(function () {
        ...
        Route::post('/', [VehicleController::class, 'showVehicle'])->name('vehicle.show')->middleware('verify.user.permission:show-vehicle');
    });
});
